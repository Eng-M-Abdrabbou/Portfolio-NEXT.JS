...
const skillsData = {
  ...
  activities: [ 
    ...
    "🏆 Winner: IEEE 19th Student Day 2025 Competition",
    "🏆 Honors: 5 Consecuitve Times in University's Honor List Throughout All Semesters",
    "🏆 Honors: 2 Consecuitve Times in Dean's Honor List",
    "🎖️ Top 5: AAU Full-ride 100% Scholarship for \" Top 5 Students Nationwide \" ",
    "🏆 Golden Visa: Distinguished Student Category",
    "🏆 100%: Perfect 100% Highschool Score in All Subjects, Top Student in All Subjects on Highschool",
    "🎖️ IEEE Active Member & Competition Participant",
