...
const GradientSpots = () => {
  return (
    <div className="absolute inset-0 w-full h-full pointer-events-none">
      ...
      <div className="absolute z-101 top-1/2 right-1/4 w-[28rem] h-[28rem] rounded-full bg-slate/10 blur-4xl opacity-75 animate-subtle-move-2"></div>
      ...
      <div className="absolute z-101 bottom-1/2 left-1/4 w-[26rem] h-[26rem] rounded-full bg-slate/10 blur-4xl opacity-75 animate-subtle-move-5"></div>
    </div>
  );
};
